...
U 1 1 5E875FA3
P 14450 7650
F 0 "U8" H 14150 7400 50  0000 C CNN
F 1 "M24C02-FDW" H 14750 7900 50  0000 C CNN
F 2 "Package_SO:TSSOP-8_4.4x3mm_P0.65mm" H 14450 8000 50  0001 C CNN
F 3 "http://www.st.com/content/ccc/resource/technical/document/datasheet/b0/d8/50/40/5a/85/49/6f/DM00071904.pdf/files/DM00071904.pdf/jcr:content/translations/en.DM00071904.pdf" H 14500 7150 50  0001 C CNN
	1    14450 7650
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F542D63
P 13950 7850
F 0 "#PWR035" H 13950 7600 50  0001 C CNN
...
U 1 1 5F5431B5
P 14450 8000
F 0 "#PWR038" H 14450 7750 50  0001 C CNN
F 1 "GND" H 14455 7827 50  0000 C CNN
...
Text Notes 14250 8350 0    50   Italic 10
ADDR: 0x50
$Comp
L power:+3V3 #PWR037
U 1 1 5F577A55
P 14450 7150
F 0 "#PWR037" H 14450 7000 50  0001 C CNN
F 1 "+3V3" H 14465 7323 50  0000 C CNN
...
U 1 1 5F577A65
P 13750 7300
F 0 "#PWR033" H 13750 7050 50  0001 C CNN
...
U 1 1 5F5B87A8
P 14950 7850
F 0 "#PWR039" H 14950 7600 50  0001 C CNN
...
Text Label 15100 7650 0    50   Italic 0
EEPROM_SCL
Text Label 15100 7550 0    50   Italic 0
EEPROM_SDA
Wire Wire Line
	14850 7550 15100 7550
Wire Wire Line
	15100 7650 14850 7650
Text Notes 13850 8850 0    118  ~ 24
2 kb EEPROM
$Comp
L power:+3V3 #PWR042
U 1 1 5F61A390
...
F 0 "C31" V 13850 7250 50  0000 C CNN
F 1 "0.1µF" V 14150 7250 50  0000 C CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" V 13840 7250 50  0001 C CNN
F 3 "https://search.murata.co.jp/Ceramy/image/img/A01X/G101/ENG/GRM155R71H104KE14-01.pdf" H 14000 7250 50  0001 C CNN
F 4 "490-13342-1-ND" H 14000 7250 50  0001 C CNN "Digi-Key PN"
F 5 "0.1µF ±10% 50V Ceramic Capacitor X7R 0402 (1005 Metric)" H 14000 7250 50  0001 C CNN "Description"
	1    14000 7250
	0    1    1    0   
$EndComp
$Comp
...
Wire Wire Line
	3600 6500 5750 6500
$Comp
L dk_LED-Indication-Discrete:LTST-C190KGKT DS?
U 1 1 5E8140AB
P 10650 5500
AR Path="/5E5BBCD5/5E8140AB" Ref="DS?"  Part="1" 
AR Path="/5E86F12A/5E8140AB" Ref="DS2"  Part="1" 
F 0 "DS2" H 10600 5879 50  0000 C CNN
F 1 "LTST-C190KGKT" H 10650 5350 60  0001 C CNN
F 2 "digikey-footprints:LED_0603" H 10850 5700 60  0001 L CNN
F 3 "http://optoelectronics.liteon.com/upload/download/DS22-2000-074/LTST-C190KGKT.PDF" H 10850 5800 60  0001 L CNN
F 4 "160-1435-1-ND" H 10850 5900 60  0001 L CNN "Digi-Key_PN"
F 5 "LTST-C190KGKT" H 10850 6000 60  0001 L CNN "MPN"
F 6 "Optoelectronics" H 10850 6100 60  0001 L CNN "Category"
F 7 "LED Indication - Discrete" H 10850 6200 60  0001 L CNN "Family"
F 8 "http://optoelectronics.liteon.com/upload/download/DS22-2000-074/LTST-C190KGKT.PDF" H 10850 6300 60  0001 L CNN "DK_Datasheet_Link"
F 9 "/product-detail/en/lite-on-inc/LTST-C190KGKT/160-1435-1-ND/386814" H 10850 6400 60  0001 L CNN "DK_Detail_Page"
F 10 "LED GREEN CLEAR CHIP SMD" H 10600 5780 60  0000 C CNN "Description"
F 11 "Lite-On Inc." H 10850 6600 60  0001 L CNN "Manufacturer"
F 12 "Active" H 10850 6700 60  0001 L CNN "Status"
	1    10650 5500
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5E8140B5
P 10900 5700
AR Path="/5E5BBCD5/5E8140B5" Ref="R?"  Part="1" 
AR Path="/5E86F12A/5E8140B5" Ref="R31"  Part="1" 
F 0 "R31" H 10968 5746 50  0000 L CNN
F 1 "75" H 10968 5655 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" V 10940 5690 50  0001 C CNN
F 3 "https://www.yageo.com/upload/media/product/productsearch/datasheet/rchip/PYu-RC_Group_51_RoHS_L_10.pdf" H 10900 5700 50  0001 C CNN
F 4 "311-75.0HRCT-ND" H 10900 5700 50  0001 C CNN "Digi-Key PN"
F 5 "75 Ohms ±1% 0.1W, 1/10W Chip Resistor 0603 (1608 Metric) Moisture Resistant Thick Film" H 10900 5700 50  0001 C CNN "Description"
	1    10900 5700
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5E8140BB
P 10900 5900
AR Path="/5E5BBCD5/5E8140BB" Ref="#PWR?"  Part="1" 
AR Path="/5E86F12A/5E8140BB" Ref="#PWR0203"  Part="1" 
F 0 "#PWR0203" H 10900 5650 50  0001 C CNN
...
Text Notes 10150 5900 0    50   Italic 0
PWR Good LED\nVf: 1.9V - 2.4V\nIF: 20 mA
Wire Notes Line
	12300 9250 12300 6500
Wire Notes Line
	12300 6500 16500 6500
$Comp
L power:+3V3 #PWR0202
U 1 1 5E87F8C4
P 9750 5300
F 0 "#PWR0202" H 9750 5150 50  0001 C CNN
F 1 "+3V3" H 9765 5473 50  0000 C CNN
